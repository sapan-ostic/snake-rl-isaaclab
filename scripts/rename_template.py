...
It renames all the occurrences of snake_rl (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the snake_rl folder
        os.rename(
            os.path.join(root_dir_path, "exts", "snake_rl", "snake_rl"),
            os.path.join(root_dir_path, "exts", "snake_rl", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "snake_rl"), os.path.join(root_dir_path, "exts", new_name))
